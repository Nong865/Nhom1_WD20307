<div class="container mt-4">
    ...
    <a href="index.php?action=viewItinerary&id=<?= $itinerary['tour_id'] ?? $tour['id'] ?>" class="btn btn-secondary mb-4">
        ← Quay lại Chi tiết Lịch trình
    </a>

    <form action="index.php?action=editItinerary&id=<?= $itinerary['id'] ?>" method="POST" class="bg-white p-4 shadow rounded">
        ...
        <div class="form-group mb-4">
            ...
            <textarea name="details" id="details" rows="6" class="form-control" 
                      placeholder="Mô tả chi tiết các hoạt động, thời gian và bữa ăn trong ngày..."><?= $itinerary['details'] ?? '' ?></textarea>
        </div>
