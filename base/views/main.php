<?php
// C:\laragon\www\DA_Nhom1\base\views\main.php

// Các biến cần thiết từ Controller (đã được định nghĩa)
// $content, $title, $active, $currentUser
...
<head>
    ...
    <style>
        ...
        .content { margin-left: 260px; padding: 20px; } /* Đảm bảo margin-left khớp với width sidebar */
